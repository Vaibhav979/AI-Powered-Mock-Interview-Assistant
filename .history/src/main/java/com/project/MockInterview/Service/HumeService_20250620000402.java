...
public class HumeService {
        private static final String HUME_TTS_URL = "https://api.hume.ai/v0/tts/synthesize/json";
        ...
        public byte[] callHumeTTS(String text) {
                ...
                headers.set("X-Hume-Api-Key", humeApiKey);
...
// It constructs the request with the necessary headers and body, sends it, and
